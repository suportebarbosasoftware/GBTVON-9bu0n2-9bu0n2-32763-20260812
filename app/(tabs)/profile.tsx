    ...
    >
      ...
      <View style={[styles.accountCard, isTV && styles.accountCardTV]}>
        <View style={styles.accountAvatarWrap}>
          <Image
            ...
            contentFit="contain"
          />
          <View style={[styles.accountStatusDot, { backgroundColor: '#4CAF50' }]} />
        </View>
        <View style={styles.accountInfo}>
          ...
          <View style={styles.accountStatusBadge}>
            <View style={[styles.accountStatusDotInline, { backgroundColor: '#4CAF50' }]} />
            <Text style={[styles.accountStatusText, { color: '#4CAF50', fontSize: isTV ? F.sm : 11 }]}>Ativa</Text>
          </View>
          {planName ? (
      ...
      <View style={styles.section}>
        ...
        <View style={styles.detailsCard}>
          <DetailRow icon="mail-outline" label="E-mail" value={userEmail || '—'} />
...
const styles = StyleSheet.create({
  ...
  accountAvatar: { width: 72, height: 72, borderRadius: 16, borderWidth: 2, borderColor: Colors.primary },
  accountAvatarTV: { width: 96, height: 96, borderRadius: 20 },
  accountStatusDot: { position: 'absolute', bottom: 2, right: 2, width: 14, height: 14, borderRadius: 7, borderWidth: 2, borderColor: '#1a0000' },
  accountInfo: { flex: 1 },
  ...
  menuRowTVFocused: { backgroundColor: 'rgba(229,0,0,0.12)', borderLeftWidth: 3, borderLeftColor: '#E50000' },
